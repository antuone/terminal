...
# вывести адрес текущей рабочей директории
pwd
...
more 1.txt
# просмотр чего либо, можно перемещатся по тексту вверх и вниз стрелочками
less
...
# ?
cut
# Поиск файлов содержащих указанный текст, рекурсивно
grep -iRI "doctype html"
